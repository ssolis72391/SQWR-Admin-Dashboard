...
export default function LanguageDropdown({ mobileHidden, items }) {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items className="origin-top-right absolute right-0 mt-2  w-32 lg:w-56 rounded-2xl bg-grey-light z-10">
          <div className="py-1">
            {items.map(item => (
              <Menu.Item key={item}>
                {({ active }) => (
